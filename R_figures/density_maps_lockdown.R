...
density_maps_lockdown = function(SAR_data_2017, SAR_data_2018, SAR_data_2019, SAR_data_2020, 
  ...
  Density_20172019_lockdown = ggplot() +
    ...
    xlim(2,11) +
    ylim(41,44)+
    labs(title = "Detections for 2017-2019 from April to June")
  
  # ggsave(Density_20172019_lockdown, file = "figures/Density_20172019_lockdown.pdf", width = 297, height = 210, units = "mm")
  ...
  Density_2020_lockdown = ggplot() +
    ...
    xlim(2,11) +
    ylim(41,44)+
    labs(title = "Detections for 2020 from April to June")
  # 
  # ggsave(Density_2020_lockdown, file = "figures/Density_2020_lockdown.pdf", width = 297, height = 210, units = "mm")
  
  lockdown = ggarrange(Density_20172019_lockdown, Density_2020_lockdown, nrow = 2, heights = c(1, 1))
  ggsave(lockdown, file = "figures/lockdown.pdf", width = 210, height = 297, units = "mm")
  ...
  Morning_density_lockdown = ggplot() +
    ...
    xlim(2,11) +
    ylim(41,44)+
    labs(title = "Morning detections for 2017-2019 from April to June")
  
  # ggsave(Morning_density_lockdown, file = "figures/Morning_density_lockdown.pdf", width = 297, height = 210, units = "mm")
  # 
  ...
  Evening_density_lockdown = ggplot() +
    ...
    xlim(2,11) +
    ylim(41,44)+
    labs(title = "Evening detections for 2017-2019 from April to June")
  
  # ggsave(Evening_density_lockdown, file = "figures/Evening_density_lockdown.pdf", width = 297, height = 210, units = "mm")
  ...
  #THIS IS FOR 2020
  Morning_2020_density_lockdown = ggplot() +
    ...
    xlim(2,11) +
    ylim(41,44)+
    labs(title = "Morning detections for 2020 from April to June")
  
  # ggsave(Morning_2020_density_lockdown, file = "figures/Morning_2020_density_lockdown.pdf", width = 297, height = 210, units = "mm")
  ...
  Evening_2020_density_lockdown = ggplot() +
    ...
    xlim(2,11) +
    ylim(41,44)+
    labs(title = "Evening detections for 2020 from April to June")
  
  # ggsave(Evening_2020_density_lockdown, file = "figures/Evening_2020_density_lockdown.pdf", width = 297, height = 210, units = "mm")
  
  lockdown_morning = ggarrange(Morning_density_lockdown, Morning_2020_density_lockdown, nrow = 2, heights = c(1, 1))
  ggsave(lockdown_morning, file = "figures/lockdown_morning.pdf", width = 210, height = 297, units = "mm")
  
  lockdown_evening = ggarrange(Evening_density_lockdown, Evening_2020_density_lockdown, nrow = 2, heights = c(1, 1))
  ggsave(lockdown_evening, file = "figures/lockdown_evening.pdf", width = 210, height = 297, units = "mm")
